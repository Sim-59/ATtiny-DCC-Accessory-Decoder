...
- The new [ATtiny-MuFuDec](https://simandit.de/simwiki/doku.php?id=modellbahn:umbauten:dcc-dekoder#dcc-multi-funktions-dekoder_4-port) must be programmed via ISP using an AVR programmer.
